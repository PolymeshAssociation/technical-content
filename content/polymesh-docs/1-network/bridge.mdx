...
Even though there is no maximum limit of how much POLY can be bridged, the Testnet side sets a limit on how much POLY is bridged per unit of time. There is going to be no such a limit on the Mainnet.
