...
title: Tokenomics
description:
slug: /polymesh-docs/network/tokenomics
...
The POLY to POLYX bridge upgrades these ERC20 POLY tokens to POLYX on the Polymesh network on a one for one basis. Bridging POLY to POLYX does not effect the total supply.
