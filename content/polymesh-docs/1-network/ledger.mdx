...
- A Chromium-based web browser installed to access the [Polymesh App](https://mainnet-app.polymesh.live/#/explorer) with.
...
The [Polymesh App](https://mainnet-app.polymesh.live/#/accounts) already has an integration with the Ledger application so that your device will work with the browser interface after installation. 
