...
NB - to install the Polymesh Ledger App you must enable `Developer Mode` under Settings in Ledger Live.

This can be found under *Settings -> Experimental Features -> Developer Mode* (Toggle on)
...
- The latest firmware installed (at the time of writing this is 2.0.0 on the Nano S, and 2.0.0 on the Nano X).
...
- Find Polymesh in the app catalog and install it. You will need to enable Developer Mode in Ledger Live (under *Settings -> Experimental Features*) to see the app in the catalog.
...
Now when you go to the *"Accounts"* tab you will see a new button that says *"Add via Ledger"*. Ensure that your Ledger device is unlocked and that you have navigated into the Polymesh application, then click this button. Whilst the app is in review, you will also need to click through when it tells you that the app is "Pending Ledger Review".
...
Ensure that your Ledger device is unlocked and that you have navigated into the Polymesh application. Whilst the app is in review, you will also need to click through when it tells you that the app is "Pending Ledger Review".
