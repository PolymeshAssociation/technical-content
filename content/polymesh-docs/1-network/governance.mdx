...
title: Governance
description:
slug: /polymesh-docs/network/governance
...
![Governance Flow Diagram](../images/Polymesh_Governance.png)
...
Currently we take a linear count of positive and negative signals and use these to order PIPs, but in the future we can consider more expressive mechanisms, such as quadratic voting by leveraging our [confidential identity](/polymesh-docs/primitives/confidential-identity) model.
...
The Goverance Council is also able to issue a [Customer Due Diligence](/polymesh-docs/primitives/cdd) claim should the need arise.
