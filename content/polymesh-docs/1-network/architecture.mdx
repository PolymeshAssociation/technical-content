...
Primitives can be extendable using constrained smart contracts called [smart extensions](/polymesh-docs/primitives/smart-extensions). These allow network users to take advantage of the standarisation and deep integration of the base layer primitives whilst facilitating complex custom logic, such as bespoke transfer restrictions.
