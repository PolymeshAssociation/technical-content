...
Each identity is referenced via a decentralized identifier - its DID. A DID is a pseudo-anonymous identifier such as `0xfc0d2fc058d02c0a89c2cc2ff11726971dd39886a0b80ecfaa80fa3f196d65ce`.
...
Assets held by an identity can be organised into [portfolios](./portfolios-and-custody) beneath that identity.
