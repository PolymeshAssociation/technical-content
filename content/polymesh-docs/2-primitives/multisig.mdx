...
These keys can be created in the Polymesh Wallet, or using the Polymesh App (https://itn-app.polymesh.live) in the Accounts tab. We've used the latter for this tutorial.
