...
What is a motion? A motion is a set of choices to which weights can be assigned. Usually motions can be confirmed ("aye"), declined ("nay"), or amended ("aye with X amendment"). 
