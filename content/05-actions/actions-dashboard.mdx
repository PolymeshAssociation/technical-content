...
How can you find the id of the corporate action? The id is recorded in the transaction. You can use `Network`, `Explorer` to spot the recent transaction. Chain state queries can help you, or automated processes, find relevant information.
