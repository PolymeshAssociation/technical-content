...
Now, Alice will receive her dividend. This can be done using a "pull" or "push" pattern, meaning either ACME can _push_ distributions to recipients, or recipients can _pull_ distributions from the capital distribution. Let us use the "pull" pattern. Alice will draw from the capital distribution.
