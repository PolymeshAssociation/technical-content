...
Following ACME's IPO, the shares are widely distributed and traded. Let us imagine that it has been a very good quarter since ACME went public and the board now wishes to distribute a dividend. Each shareholder will be entitled to receive a portion of the dividend in proportion to the number of shares they own.
