...
<OverviewBox title="Overview: Corporate action on Polymesh" linkHref="/actions/introduction" linkText="Overview" imgSrc="/illu-p-screen.svg">
...
<ActionCardWrapper>
	<ActionCard href="/actions/dashboard" text="Corporate Actions with the Token Studio Dashboard" desc="Distribute assets with the Polymesh Token Studio Dashboard."></ActionCard>
