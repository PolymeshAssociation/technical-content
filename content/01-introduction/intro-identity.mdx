...
> A **uID** represents an individual or an organisation. A uID may control more than one account but no one should have more than uID.
...
The corresponding on-chain concept in Polymesh is a **Polymesh "distributed ID" (DID)**, implemented as a large number and representing an account. You may not choose your DID, but it is sufficiently obfuscated to protect your privacy.
...
Adding just a little bit of precision to the foregoing description, an entity has its own Polymesh DID, has zero or more secondary keys, and a primary key. Secondary keys have well-defined permissions outlining what they can do on behalf of the account. Secondary keys and prmissions are managed by the primary key.
...
Portfolios relate strongly to custody on Polymesh. For a more detailed account, take a look at: [https://developers.polymesh.live/polymesh-docs/primitives/portfolios_custody/](/polymesh-docs/primitives/portfolios-custody/).
...
Refer to the reference documentation for details on [permissioned roles](https://developers.polymesh.live/polymesh-docs/network/permissioned_roles/) and [authorisations](/polymesh-docs/primitives/authorisations/).
...
For more information on this topic, prospective KYC service providers should review the admission process described [here](/kyc/kyc-introduction).
...
!--> Change link to CDD section in KYC module once content is finalised -->

## Links

- Primitives: Identity https://developers.polymesh.live/polymesh-docs/primitives/identity/
- Primitives: Confidential Identity: https://developers.polymesh.live/polymesh-docs/primitives/confidential-identity/
- Primitives: Customer due diligence: https://developers.polymesh.live/polymesh-docs/primitives/cdd/
- Primitives: Portfolios and Custody: https://developers.polymesh.live/polymesh-docs/primitives/portfolios-custody/
- Primitives: Compliance: https://developers.polymesh.live/polymesh-docs/primitives/compliance/
- Primitives: Authorizations: https://developers.polymesh.live/polymesh-docs/primitives/authorisations/
- Polymesh Network: Permissioned Roles: https://developers.polymesh.live/polymesh-docs/network/permissioned-roles/
