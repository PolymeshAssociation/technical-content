...
The corresponding on-chain concept in Polymesh is the **Polymesh "distributed ID" (DID)**, implemented as a large number. You may not choose "petrolhead1980", but it is sufficiently obfuscated that you can keep a good level of privacy.
