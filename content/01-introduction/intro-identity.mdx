...
For more information on this topic, prospective KYC service providers should review the admission process described [here](/kyc/).
...
For a more in-depth look at CDD on Polymesh, dive right into [Polymesh's CDD](/kyc/).
