...
Portfolios relate strongly to custody on Polymesh. For a more detailed account, take a look at: [https://developers.polymesh.live/polymesh-docs/primitives/portfolios_custody/](/polymesh-docs/primitives/portfolios-and-custody/).
...
Refer to the reference documentation for details on [permissioned roles](/polymesh-docs/network/permissioned_roles/) and [authorisations](/polymesh-docs/primitives/authorisations/).
...
For a more in-depth look at CDD on Polymesh, dive right into [Polymesh's CDD](/kyc/kyc-introduction).
