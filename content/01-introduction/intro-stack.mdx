...
You want to know more about the Polymesh Wallet? Take a look at our section on the [Wallet](/quickstart/quickstart-wallet)!
...
For a step-by-step on how to setup everything, so that you can start playing around with the Dashboard, take a look at [Quick Start](/quickstart/quickstart-landingpage).
