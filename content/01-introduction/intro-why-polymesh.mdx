...
Moreover, the Polymesh blockchain has its own native token for payments and security requirements called [POLYX](https://developers.polymesh.live/polyx/).
...
- Polymesh Tokenomics: https://developers.polymesh.live/polymesh-docs/network/tokenomics/
- Polymesh Consensus: https://developers.polymesh.live/polymesh-docs/network/consensus/
