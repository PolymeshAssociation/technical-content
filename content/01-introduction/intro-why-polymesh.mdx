...
To provide a blockchain specialised for security tokens, Polymesh is built on **five pillars**: identity, confidentiality, compliance, settlement, and governance.
...
Polymesh solves the inherent challenges of public general-purpose blockchains in regard to identity, confidentiality, compliance, settlement, and governance with a bespoke end-to-end solution.
