...
Various parameters in the system that one might associate with super-user controls as well as the upgrade process itself are managed through a well-defined, **decentralised [governance process](/introduction/intro-governance)** that includes gathering votes from network users.
