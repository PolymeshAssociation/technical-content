...
Arriving at a consensus about the ordered list of transactions is a core concern of any blockchain network. These are many processes to choose from. For example, Proof-of-Work (PoW) and Practical Byzantine Fault Tolerance (pBFT).
