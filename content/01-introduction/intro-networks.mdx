...
The Alcyone testnet is a fully-functional Polymesh network where you can experiment and test without financial consequence. Use the testnet to practice and experiment!
...
Notice how the wallet defaults to the Alcyone testnet (at the time of writing)? The default is set so that one needs to be explicit about transacting with actual assets.
