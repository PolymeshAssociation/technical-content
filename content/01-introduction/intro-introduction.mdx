...
<OverviewVideoBox title="Polymath webcast" videoId="Hrp1GGgdoQ8">
    ...
    You can watch the whole talk in one go or pick the parts related to each section of the portal.
</OverviewVideoBox>
...
<OverviewBox title="Discovering the testnets, local networks, and mainnet" linkHref="/introduction/networks" linkText="Discovering the testnets, local networks, and mainnet" imgSrc="/tmpAssets/06_testnets_mainnet-01.svg" floating="true">

It is important to know where to test, in other words play around, and where to deploy when it gets serious. You don’t want to accidentally experiment in the mainnet - This can be costly in all senses.
