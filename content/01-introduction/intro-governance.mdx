...
First, open up your browser and check that you are logged into your Polymesh Wallet. Open the dashboard by going to: [https://dashboard.polymesh.network/](https://dashboard.polymesh.network/).
