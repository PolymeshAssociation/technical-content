...
Feeling unsure about the <b>Polymesh Confidentiality Identity Mechanism</b>? Check out the section on [identity](/introduction/identity) again!
...
How can a user link identities? Taking the entity ID and the on-chain commitments to the entity ID, a user can add a self-issued Scope Claim linking identitiese.
