...
You will be presented with the below screen. Click the `New Application` button. (On mainnet you can alternately click on the link to Fractal's portal should you wish to onboard with them as your CDD provider. **Do not select Fractal on Testnet**)
