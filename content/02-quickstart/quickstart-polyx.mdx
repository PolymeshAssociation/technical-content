...
POLYX is the network transaction fees token as well as the governance token that helps decentralise network management.

You will need POLYX to complete the exercises.

## Testnet POLYX

Testnet is where you can practise using Polymesh without material consequences. As the name suggests, it is a fully functional Polymesh network. The main differences are:
