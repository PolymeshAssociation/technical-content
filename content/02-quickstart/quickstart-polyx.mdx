...
As you may have already guessed, Polymath has published a contract on Ethereum that gives away free testnet POLY. That is what you need to proceed across the bridge and upgrade it to POLYX on Polymesh.
...
Now that you have testnet POLY and a way to pay for transactions on the Ethereum network, you can proceed to the Polymesh Bridge to upgrade your POLY to POLYX.
