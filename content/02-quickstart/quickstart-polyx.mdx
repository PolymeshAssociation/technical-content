...
If you completed [CDD](/02-quickstart/quickstart-cdd) (you should), then the site will indicate that your Polymesh Account is verified. If not, then you will be directed to customer due diligence.
