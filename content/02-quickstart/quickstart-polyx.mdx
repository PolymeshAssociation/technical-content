...
Point your browser to the dashboard explorer and select POLY to POLYX Bridge - [https://dashboard.polymesh.network/explore](https://dashboard.polymesh.network/explore)
