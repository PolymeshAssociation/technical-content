...
<OverviewBox title="Get the Wallet" linkHref="/quickstart/quickstart-wallet" linkText="Get the Wallet" imgSrc="/tmpAssets/07_get_wallet_v2-01.svg" floating="true">
...
<OverviewBox title="Get Verified" linkHref="/quickstart/quickstart-cdd" linkText="Get Verified" imgSrc="/tmpAssets/08_get_verified_v3-01.svg" floating="true">
...
POLYX is the native token for paying transaction fees and voting on governance proposals. Get testnet POLYX at no cost so you can experiment with the Alcyone testnet.
