...
<OverviewBox title="Overview: Distributing assets with Polymesh" linkHref="/distribute/introduction" linkText="Overview" imgSrc="/illu-p-screen.svg">
...
<ActionCardWrapper>
	<ActionCard href="/settlement/settlement-dashboard" text="Distribute an asset using the Dashboard" desc="Distribute assets, such as dividend payments with your browser and the Polymesh Dashboard."></ActionCard>
	<ActionCard href="/settlement/sdk" showDevSign="true" text="Originate an asset with the SDK" desc="Integrate asset distribution into your systems with the SDK."></ActionCard>
</ActionCardWrapper>
