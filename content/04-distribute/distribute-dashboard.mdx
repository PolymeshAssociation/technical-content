...
In the [secondary keys section](/originate/secondary), we created distinct accounts for Alice and ACME, and Alice created a secondary key to use when she signs on behalf of ACME as the CEO.
...
Switch to Alice's personal Polymesh account by bringing her personal primary key into focus in the wallet.
