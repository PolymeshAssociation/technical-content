...
Here too, in `issuance`, the context is still `apiCeo`. In fact, its [`parent`](https://developers.polymath.network/polymesh-sdk-api-reference/classes/issuance#properties-1) is the `asset` itself.
