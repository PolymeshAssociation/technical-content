...
Now that we have the venue, let's have the CEO [issue](https://developers.polymath.network/polymesh-sdk-api-reference/v/docs-alpha/classes/issuance#issue) enough shares to later transfer to Alice. Of course, if the CEO planned on issuing shares for all founders of ACME Corp, she would issue more.
