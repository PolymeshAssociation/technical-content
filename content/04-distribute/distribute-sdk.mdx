...
It is this `portfolioId` that could be used to retrieve it at a later date. Time to [move](https://developers.polymath.network/polymesh-sdk-api-reference/classes/portfolio#movefunds) the shares:
