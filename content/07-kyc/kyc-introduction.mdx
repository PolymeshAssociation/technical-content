...
Refer to the quick start to [learn how to complete CDD](/quickstart/quickstart-cdd).
...
- Primitives:
    - Identity: https://developers.polymesh.live/polymesh-docs/primitives/identity/
    - Confidential Identity: https://developers.polymesh.live/polymesh-docs/primitives/confidential-identity/
