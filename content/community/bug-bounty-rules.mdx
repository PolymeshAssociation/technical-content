...
To submit a Vulnerability, you must complete and submit our Vulnerability Disclosure Form, found at one of our approved platforms, as mentioned in the program overview: [https://developers.polymesh.live/community/bug-bounty#overview](https://developers.polymesh.live/community/bug-bounty#overview) (each such submission, a **"Report"**).  

All Reports must comply with our Report requirements. You can find our Report requirements, Program processes and tips on submitting a Report, at: [https://developers.polymesh.live/community/bug-bounty](/community/bug-bounty).  
