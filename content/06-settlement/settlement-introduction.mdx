...
When a user assigns custodianship to a portfolio, the custodial control is transferred to a different identity. This form of permission separates beneficial ownership from custodial control.
...
**Custodial control** gives another entity, i.e. account, the right to manage assets on behalf of the beneficiary. This is where custody service providers come into play on Polymesh.
...
If you are feeling unsure about accounts, signing keys and permissions, take a look at the [identity section](/introduction/intro-identity)!
