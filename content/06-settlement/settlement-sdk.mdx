...
The instruction has been affirmed, but it is possible that it has not be executed yet because of a missing compliance from one or more of the parties. Let's assume that the transaction was left pending and is now ready to be executed again, and that it is SafeHands who have decided to post this transaction.
