...
* SafeHands:
    ...
    const safeHands: Identity = await apiSafeHands.getCurrentIdentity();
...
* NextDaq:
    ...
    const nextDaq: Identity = await apiNextDaq.getCurrentIdentity();
...
assert(isPossible === TransferSuccess.Success);
```
